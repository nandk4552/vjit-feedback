            ...
            <div className="profiles">
              <center>
                ...
                <select name="oeSubjSec" id="s1" onChange={Handler}>
                  ...
                  <option value="ELEMENTS OF CIVIL ENGINEERING">
                    ELEMENTS OF CIVIL ENGINEERING
                  </option>
                  <option value="SMART CITIES-A">SMART CITIES-A</option>
                  <option value="SMART CITIES-B">SMART CITIES-B</option>

                  <option value="DISASTER MANAGEMENT-A">
                    DISASTER MANAGEMENT-A
                  </option>
                  <option value="DISASTER MANAGEMENT-B">
                    DISASTER MANAGEMENT-B
                  </option>

                  <option value="NON-CONVENTIONAL ENERGY SOURCES-A">
                    NON-CONVENTIONAL ENERGY SOURCES-A
                  </option>
                  <option value="NON-CONVENTIONAL ENERGY SOURCES-B">
                    NON-CONVENTIONAL ENERGY SOURCES-B
                  </option>

                  <option value="FUNDAMENTALS OF ELECTRICAL POWER GENERATION AND PROTECTION">
                    FUNDAMENTALS OF ELECTRICAL POWER GENERATION AND PROTECTION
                  </option>
                  <option value="ELEMENTS OF MECHANICAL ENGINEERING">
                    ELEMENTS OF MECHANICAL ENGINEERING
                  </option>

                  <option value="PRODUCT ENGINEERING-A">
                    PRODUCT ENGINEERING-A
                  </option>
                  <option value="PRODUCT ENGINEERING-B">
                    PRODUCT ENGINEERING-B
                  </option>

                  <option value="INTRODUCTION TO MICROCONTROLLERS">
                    INTRODUCTION TO MICROCONTROLLERS
                  </option>
                  <option value="BASIC ELECTRONICS">BASIC ELECTRONICS</option>
                  <option value="BASICS OF OPERATION SYSTEMS">
                    BASICS OF OPERATION SYSTEMS
                  </option>

                  <option value="CORE JAVA PROGRAMMING-A">
                    CORE JAVA PROGRAMMING-A
                  </option>
                  <option value="CORE JAVA PROGRAMMING-B">
                    CORE JAVA PROGRAMMING-B
                  </option>

                  <option value="FUNDAMENTALS OF COMPUTER NETWORKS">
                    FUNDAMENTALS OF COMPUTER NETWORKS
                  </option>
                  <option value="FOUNDATION OF ARTIFICIAL INTELLIGENCE">
                    FOUNDATION OF ARTIFICIAL INTELLIGENCE
                  </option>
                  <option value="TOTAL QUALITY MANAGEMENT-A">
                    TOTAL QUALITY MANAGEMENT-A
                  </option>
                  <option value="TOTAL QUALITY MANAGEMENT-B">
                    TOTAL QUALITY MANAGEMENT-B
                  </option>
                  <option value="TOTAL QUALITY MANAGEMENT-C">
