            ...
            <nav className="navbar bg-dark justify-content-left">
                ...
                <section className="container">
                    ...
                    <form onSubmit={verifyHandler}>
                        <input className="form-control-lg m-1 border" style={{width:"50%"}} type="text"    placeholder="Enter Admin username"    name="username" value={username}   onChange={changeHandler3} /><br /><br />
